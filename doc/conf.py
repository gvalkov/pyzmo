...
latex_documents = [
  ('index', 'pyzmo.tex', u'pyzmo documentation',
...
man_pages = [
    ('index', 'pyzmo', u'pyzmo documentation',
     [u'Georgi Valkov'], 1)
]
...
texinfo_documents = [
  ('index', 'pyzmo', u'pyzmo documentation',
   u'Georgi Valkov', 'pyzmo', 'tiny hotkey library based on python-evdev',
   'Miscellaneous'),
]
